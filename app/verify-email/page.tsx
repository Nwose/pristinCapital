            ...
            <div className="bg-white rounded-lg shadow-xl p-12 border border-gray-100">
              {!isSuccess ? (
                      ...
                      <div className="flex justify-center space-x-4 mb-6">
                        {otp.map((digit, index) => (
                          <input
                            ...
                            className={`w-16 h-16 border-2 rounded-lg text-center text-2xl font-semibold text-gray-700 focus:outline-none transition-all ${
                              isError
                    ...
                    <div className="text-center space-y-3">
                      {isExpired && (
                        <button
                          ...
                          className="text-teal-600 cursor-pointer hover:underline font-semibold block w-full"
                        >
                          Resend Code
                        </button>
                      )}
                ...
                <div className="text-center">
                  ...
                  <h2 className="text-2xl font-bold text-green-600 mb-6 leading-tight">
                  ...
                  <button
                    ...
                    className="w-full bg-slate-800 hover:bg-slate-900 text-white py-4 rounded-sm font-semibold text-lg transition-colors shadow-lg"
                  >
                    Continue
                  </button>
                </div>
