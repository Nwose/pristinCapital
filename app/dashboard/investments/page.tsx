...
// // import WithdrawModal from "@/app/dashboard/investments/WithdrawModal";
...
//   // ✅ move function inside component so it can access router
...
//           className="bg-[#012638] text-white px-8 py-2 rounded-lg font-semibold text-base hover:bg-[#019893] transition-colors"
//         >
//           Fund Wallet
//         </button>
//       </div>
...
//             <button
//               onClick={handleInvestClick}
//               className="w-full bg-[#012638] text-white py-2 rounded-lg font-semibold text-base hover:bg-[#019893] transition-colors"
//             >
//               Invest Now
//             </button>
//           </div>
