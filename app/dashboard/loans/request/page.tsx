                ...
                {index < steps.length - 1 && (
                  <div
                    className={`h-1 flex-1 mx-2 rounded transition-all ${
                      currentStep > step.number ? "bg-[#019893]" : "bg-gray-200"
                    }`}
                  />
                )}
              </React.Fragment>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <input
                    ...
                    step="10000"
                    value={formData.amount_requested || parseFloat(selectedProduct.min_amount)}
                    onChange={(e) => {
                      setFormData({
                        ...formData,
                        amount_requested: e.target.value,
                    ...
                    style={{
                      background: `linear-gradient(to right, #019893 0%, #019893 ${
                        ((parseFloat(formData.amount_requested || selectedProduct.min_amount) - parseFloat(selectedProduct.min_amount)) /
                          (parseFloat(selectedProduct.max_amount) - parseFloat(selectedProduct.min_amount))) *
                        100
                      }%, #e5e7eb ${
                        ((parseFloat(formData.amount_requested || selectedProduct.min_amount) - parseFloat(selectedProduct.min_amount)) /
                          (parseFloat(selectedProduct.max_amount) - parseFloat(selectedProduct.min_amount))) *
